...
class SubClient(client.Client):
    ...
    def repost_blog(self, content: str = None, blogId: str = None, wikiId: str = None):
        ...
        data = json.dumps({
            "content": content,
            "refObjectId": str(refObjectId),
            "refObjectType": str(refObjectType),
            "type": 2,
            "timestamp": int(timestamp() * 1000)
        })
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None, isGuest: bool = False, rkfId:int=43196704):
        data = {
            "content": message,
            "stickerId": None,
            "clientRefId": rkfId,
